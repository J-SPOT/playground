...
public enum ErrorCode {
    ...
    ARTICLE_CREATION_HAS_ID(HttpStatus.BAD_REQUEST, "A2", "유효한 id가 아닌 게시글 생성 요청입니다."),
    ...
    COMMENT_CREATION_HAS_ID(HttpStatus.BAD_REQUEST, "C2", "유효한 id가 아닌 댓글 생성 요청입니다."),
    COMMENT_UPDATE_NOT_VALID(HttpStatus.BAD_REQUEST, "C3", "수정하려는 댓글 id와 요청하는 댓글id가 일치하지 않습니다.");
